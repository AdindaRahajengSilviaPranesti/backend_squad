...
const vcc_skb = new Sequelize(config.vcc_skb.database, config.vcc_skb.username, config.vcc_skb.password, config.vcc_skb);
const al4_skb = new Sequelize(config.al4_skb.database, config.al4_skb.username, config.al4_skb.password, config.al4_skb);
