...
module.exports = {
    getFlowReleaseOCI1: async (req, res) => {
        VFlow.findAll({
            ...
            //  select: ['tgl', 'lotno', 'prod_order', 'product', 'prod_start', 'fg_quarantine', 'sim_mikro', 'sim_ipc', 'inspeksi', 'capa', 'dynamic_form', 'ccp']
            attributes: ['tgl', 'lotno', 'prod_order', 'product', 'prod_start', 'fg_quarantine', 'sim_mikro', 'sim_ipc', 'inspeksi', 'capa', 'dynamic_form', 'ccp']
        })
        .then((data) => {
            res.status(200).json({
  ...
  getFlowReleaseOCI1OLD: async (req, res) => {
    try {
      let query;
